      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              India's open-mic platform. Discover live shows, book tickets, and showcase your talent across comedy, music, poetry, and more.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { to: '/register', label: 'Become a Performer' },
                { to: '/register', label: 'Buy Tickets' },
              ].map((link) => (
                <li key={link.label}>
        ...
        <div className="mt-10 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} MicDrop. All rights reserved.
          </p>
          <p className="text-gray-600 text-xs">
            Made with love for India's open-mic community
          </p>
        </div>
      </div>
    </footer>
